...
(function (factory) {
	...
	var doUpload = function doUpload(element, options) {
		...
		if (!element.data("init")) {
			(function () {
				...
				element.append(function () {
					var innerHtml = "<div class='contain'>" + "<button class='switch btn btn-info'><i class='fa fa-upload'></i>" + title + "</button>" + "<div class='panel'>" + "<div class='head'>" + "<button class='add btn btn-info'><i class='fa fa-plus'></i>add new row</button>" + "<button class='submit btn btn-warning'>submit</button>" + "</div>" + "<div class='body'>" + "<table class='table table-bordered table-condensed table-hover'>" + "<thead><tr><th>file</th><th>name</th><th>size</th><th>status</th><th>remove</th></tr></thead>" + "<tbody></tbody></table>" + "</div>" + "</div>" + "</div>";
					return innerHtml;
				});
