...
(function (factory) {
	...
	var doDatepicker = function(element,options){
		...
		if(!element.data("init")){
			...
			element.append(function(){
				var headHtml = "<div class='head'><label>datepicker</label>" +
				"<button class='previous'><i class='fa fa-chevron-up'></i></button>"+
				"<button class='next'><i class='fa fa-chevron-down'></i></button>"+
				"</div>";
				var bodyHtml = "<div class='body'></div>";
				var innerHtml =
				"<div class='contain'>"+
				"<input class='form-control'><button class='switch btn btn-info'><i class='fa fa-calendar'></i></button>"+
				"<div class='panel'>"+
				headHtml + bodyHtml +
				"</div>"+
				"</div>"
