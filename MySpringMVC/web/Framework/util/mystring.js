    ...
    _createClass(myString, [{
        ...
        value: function base64Encode() {
            ...
            while (i < this.value.length) {
                chr1 = this.value.charCodeAt(i++);
                chr2 = this.value.charCodeAt(i++);
                chr3 = this.value.charCodeAt(i++);
                enc1 = chr1 >> 2;
                ...
                result += base64KeyStr.charAt(enc1) + base64KeyStr.charAt(enc2) + base64KeyStr.charAt(enc3) + base64KeyStr.charAt(enc4);
            }
            this.value = result;
            return this;
        }
        ...
        /**
         * md5 32 bit lower encode
         * @returns {mystring}
         */

    }, {
        key: 'md5Encode',
        value: function md5Encode() {
            var result = "";
            ...
            var S41 = 6,
                ...
                S44 = 21;
            this.utf8Encode();
            x = convertToWordArray(this.value);
            a = 0x67452301;
            b = 0xEFCDAB89;
            c = 0x98BADCFE;
            d = 0x10325476;
        ...
        value: function utf8Decode() {
            ...
            while (i < this.value.length) {
                ...
                if (c < 128) {
                    ...
                    c2 = this.value.charCodeAt(i + 1);
                    result += String.fromCharCode((c & 31) << 6 | c2 & 63);
                    i += 2;
                } else {
                    c2 = this.value.charCodeAt(i + 1);
                    c3 = this.value.charCodeAt(i + 2);
        ...
        key: 'urlBase64Decode',
        value: function urlBase64Decode() {
            this.urlDecode();
            this.base64Decode();
            return this;
        }
