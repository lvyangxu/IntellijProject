...
//string encode
String.prototype.encode = function(charset) {
	var result = "";
	...
	case "base64":
		...
		while (i < input.length) {
			...
			result = result + base64KeyStr.charAt(enc1)
					+ base64KeyStr.charAt(enc2) + base64KeyStr.charAt(enc3)
...
//string decode
String.prototype.decode = function(charset) {
	var result = "";
	var base64KeyStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
	switch (charset) {
	case "utf8":
